...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20231028_hillcresthotsauce_d20279439d3fd26f1303_20231028025908_archive.zip';
        const ARCHIVE_SIZE       = '573018003';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'd202794-28025908';
        const SECONDARY_PACKAGE_HASH = '17dbb7c-28025908';
        const VERSION            = '1.5.6';
